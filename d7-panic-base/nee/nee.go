...
// HandleFunc defines the request handler used by nee
...
type (
	...
	Engine struct {
		*RouterGroup
		...
		htmlTemplate *template.Template // for html render 将所有的模板加载进内存
...
// New is the constructor of nee.Engine
func New() *Engine {
...
// POST defines the method to add POST requet
...
func (group *RouterGroup) createStaticHandler(relativePath string, fs http.FileSystem) HandlerFunc {
	...
	return func(c *Context) {
		...
		// check if file exists and/or if we have permissio to access it
